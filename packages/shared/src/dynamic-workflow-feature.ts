 ...
 */
export const QCODE_DYNAMIC_WORKFLOW_MODE_ENV = "QCODE_DYNAMIC_WORKFLOW_MODE";
...
export function resolveDynamicWorkflowClientConfig(input: {
  ...
  const override = normalizeDynamicWorkflowMode(input.env?.[QCODE_DYNAMIC_WORKFLOW_MODE_ENV]);
