...
export class ProviderSettingsFacade {
  ...
  getView(): ProviderSettingsView {
    ...
    return createProviderSettingsView({
      ...
      qcodeBuiltinProviders: snapshot.config.qcodeBuiltinProviders,
      qcodeBuiltinProviderTemplates: snapshot.config.qcodeBuiltinProviderTemplates,
  ...
  resolveModelConfig(input: ResolveModelConfigInput): ModelConfigResolution {
    ...
    if (!("personalConfig" in input)) {
      const modelRules = ModelConfigRules.composeEffective(
        snapshot.config.qcodeBuiltinModelRules,
    ...
    const inheritedConfig = snapshot.config.qcodeBuiltinModelRules.resolve({
      providerId: input.providerId,
      templateId: provider.templateId,
      modelId: input.modelId,
      apiType: provider.config.api?.type,
...
function createProviderSettingsView(input: {
  revision: number;
  qcodeBuiltinProviders: ProviderRegistryServiceSnapshot["config"]["qcodeBuiltinProviders"];
  qcodeBuiltinProviderTemplates: ProviderRegistryServiceSnapshot["config"]["qcodeBuiltinProviderTemplates"];
  ...
  return Object.freeze({
    ...
    providerTemplates: Object.freeze(
      (input.qcodeBuiltinProviderTemplates ?? ProviderTemplateMap.empty())
        .entries()
