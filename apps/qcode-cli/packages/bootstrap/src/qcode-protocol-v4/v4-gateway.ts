...
import { localTtftNow, localTtftFactsSchema } from "@qcode/shared/qcode-protocol-v4";
import {
...
import type { ConversationSnapshot } from "@qcode/shared/qcode-protocol-v4";
...
export class ConversationV4Gateway {
   ...
   * effect 之前，而 CLI 严格串行派发请求（`qcode-protocol/transport.ts`，只有 session/stop
