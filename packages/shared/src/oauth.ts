...
/** 凭据解密失败稳定错误码 */
export const CREDENTIAL_DECRYPT_ERROR_CODE = "QCODE_CREDENTIAL_DECRYPT_FAILED" as const;
...
export const QCODE_JWT_INVALID_BROADCAST_CHANNEL = "auth:qcode-jwt-invalid";
