export const QCODE_AGENT_PROVIDER_NOT_READY_CODE = "QCODE_AGENT_PROVIDER_NOT_READY" as const;
export const QCODE_AGENT_PROVIDER_NOT_READY_REASON = "provider_not_ready" as const;
