...
import type { V4InteractionRegistry } from "../qcode-protocol-v4/interaction-registry.js";
import type { ConversationV4Gateway } from "../qcode-protocol-v4/v4-gateway.js";
...
export function requireSession(
  ...
  if (!record) {
    ...
    context.logger?.warn("ZCode Protocol session runtime missing", {
      ...
      event: "qcode_protocol.session.require_missing",
