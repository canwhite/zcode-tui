import type { EmbeddedSearchBackend } from "@qcode/contracts";
import { getRuntimeToolRuntime } from "@qcode/shared";

const EMBEDDED_SEARCH_COMMAND_ENV = "QCODE_EMBEDDED_SEARCH_COMMAND";
