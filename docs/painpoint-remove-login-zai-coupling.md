...
| ---------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 位置             | `bootstrap/src/auth-login*.ts`、`cli/src/{login-command,tui-auth,command-center/login-flow}.ts`、`adapters/src/auth/{cli-oauth,coding-plan-api-key,browser}.ts` | `adapters/src/model/official-coding-plan-gateway.ts:22-31`、`config/provider/qcode-builtin.json:747/810/832/854`、`cli-oauth.ts:4`、`coding-plan-api-key.ts:4` |
