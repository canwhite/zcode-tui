...
import type { ZCodeSessionMode, ZCodeSessionSettingsState } from "./qcode-protocol/index.js";
import type { ZCodeConfigOption, ZCodeTaskModeInfo } from "./qcode-task-types-core.js";
...
export function getZCodeAgentAvailableModes(): ZCodeTaskModeInfo[] {
  return QCODE_AGENT_MODE_OPTIONS.map((mode) => ({ ...mode }));
}
