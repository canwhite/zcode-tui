import { z } from "zod";
import { zcodeSyntheticUserMessageSourceSchema } from "../qcode-protocol-legacy-types.js";
...
const toolLifecycleFactSchema = z
  .object({
    ...
    skillSource: z.enum(["agents", "qcode", "bundled", "plugin", "remote"]).optional(),
...
type TurnStartedConversationTelemetryFact = Extract<
  ...
  { kind: "turn.started" }
> &
  import("../qcode-task-types-core.js").ZCodeBackgroundTurnAttribution;
